...
public class IronGolemTech {
  ...
  public static final MobTechGeneric MUTATION_BERSERK_GOLEM = new MobTechGeneric("SUPREME_BERSERK_GOLEM", "Berserk Mutant Golem",
  ...
  public static final MobTechGeneric MUTATION_LUCK_GOLEM = new MobTechGeneric("SUPREME_LOCK_GOLEM", "Lucky Mutant Golem",
      "ef6e7a9c941e71bbfeb9ccdf91119ed7868bef05e661b1e14d3e34a9b17088d9", MobTechType.MUTATION_LUCK);

  public static final MobTechGeneric ROBOTIC_CLONING_GOLEM = new MobTechGeneric("SUPREME_CLONING_GOLEM", "Cloner Robotic Golem",
