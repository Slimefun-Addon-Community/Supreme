...
public class SupremeCoreNature {
  ...
  public static final SlimefunItemStack RESOURCE_CORE_OAK_LOG = new SlimefunItemStack("SUPREME_CORE_OAK_LOG",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_SPRUCE_LOG = new SlimefunItemStack("SUPREME_CORE_SPRUCE_LOG",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_BIRCH_LOG = new SlimefunItemStack("SUPREME_CORE_BIRCH_LOG",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_JUNGLE_LOG = new SlimefunItemStack("SUPREME_CORE_JUNGLE_LOG",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_ACACIA_LOG = new SlimefunItemStack("SUPREME_CORE_ACACIA_LOG",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_DARK_OAK_LOG = new SlimefunItemStack("SUPREME_CORE_DARK_OAK_LOG",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_CRIMSON_STEM = new SlimefunItemStack("SUPREME_CORE_CRIMSON_STEM",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_WARPED_STEM = new SlimefunItemStack("SUPREME_CORE_WARPED_STEM",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_WITHER_ROSE = new SlimefunItemStack("SUPREME_CORE_WITHER_ROSE",
