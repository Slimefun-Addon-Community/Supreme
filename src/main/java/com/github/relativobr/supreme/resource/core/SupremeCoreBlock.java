...
public class SupremeCoreBlock {
  ...
  public static final SlimefunItemStack RESOURCE_CORE_STONE = new SlimefunItemStack("SUPREME_CORE_STONE",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_GRANITE = new SlimefunItemStack("SUPREME_CORE_GRANITE",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_DIORITE = new SlimefunItemStack("SUPREME_CORE_DIORITE",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_ANDESITE = new SlimefunItemStack("SUPREME_CORE_ANDESITE",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_GRAVEL = new SlimefunItemStack("SUPREME_CORE_GRAVEL",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_SAND = new SlimefunItemStack("SUPREME_CORE_SAND",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_ENDSTONE = new SlimefunItemStack("SUPREME_CORE_ENDSTONE",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_CLAY = new SlimefunItemStack("SUPREME_CORE_CLAY",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_SNOW = new SlimefunItemStack("SUPREME_CORE_SNOW",
