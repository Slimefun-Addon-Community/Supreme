...
public class SupremeCoreColor {
  ...
  public static final SlimefunItemStack RESOURCE_CORE_RED = new SlimefunItemStack("SUPREME_CORE_RED",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_YELLOW = new SlimefunItemStack("SUPREME_CORE_YELLOW",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_PURPLE = new SlimefunItemStack("SUPREME_CORE_PURPLE",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_BLUE = new SlimefunItemStack("SUPREME_CORE_BLUE",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_BLACK = new SlimefunItemStack("SUPREME_CORE_BLACK",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_GREEN = new SlimefunItemStack("SUPREME_CORE_GREEN",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_PINK = new SlimefunItemStack("SUPREME_CORE_PINK",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_GRAY = new SlimefunItemStack("SUPREME_CORE_GRAY",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_CYAN = new SlimefunItemStack("SUPREME_CORE_CYAN",
