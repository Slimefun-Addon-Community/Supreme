...
public class SupremeCoreDeath {
  ...
  public static final SlimefunItemStack RESOURCE_CORE_PORKCHOP = new SlimefunItemStack("SUPREME_CORE_PORKCHOP",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_BEEF = new SlimefunItemStack("SUPREME_CORE_BEEF",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_MUTTON = new SlimefunItemStack("SUPREME_CORE_MUTTON",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_CHICKEN = new SlimefunItemStack("SUPREME_CORE_CHICKEN",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_SALMON = new SlimefunItemStack("SUPREME_CORE_SALMON",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_COD = new SlimefunItemStack("SUPREME_CORE_COD",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_STRING = new SlimefunItemStack("SUPREME_CORE_STRING",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_SPIDER_EYE = new SlimefunItemStack("SUPREME_CORE_SPIDER_EYE",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_TEAR = new SlimefunItemStack("SUPREME_CORE_TEAR",
