...
public class SupremeCoreAlloy {
  ...
  public static final SlimefunItemStack RESOURCE_CORE_COAL = new SlimefunItemStack("SUPREME_CORE_COAL",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_IRON = new SlimefunItemStack("SUPREME_CORE_IRON",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_GOLD = new SlimefunItemStack("SUPREME_CORE_GOLD",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_REDSTONE = new SlimefunItemStack("SUPREME_CORE_REDSTONE",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_LAPIS = new SlimefunItemStack("SUPREME_CORE_LAPIS",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_DIAMOND = new SlimefunItemStack("SUPREME_CORE_DIAMOND",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_EMERALD = new SlimefunItemStack("SUPREME_CORE_EMERALD",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_QUARTZ = new SlimefunItemStack("SUPREME_CORE_QUARTZ",
  ...
  public static final SlimefunItemStack RESOURCE_CORE_NETHERITE = new SlimefunItemStack("SUPREME_CORE_NETHERITE",
