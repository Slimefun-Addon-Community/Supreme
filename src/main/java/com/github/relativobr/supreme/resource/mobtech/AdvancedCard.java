...
public class AdvancedCard {
  ...
  public static final SlimefunItemStack CARD_SOLDER_INGOT = new SlimefunItemStack("SUPREME_CARD_SOLDER",
  ...
  public static final SlimefunItemStack CARD_BILLON_INGOT = new SlimefunItemStack("SUPREME_CARD_BILLON",
      Material.MUSIC_DISC_BLOCKS, "&bCard Machine Billon Ingot", "", "&fChange to Production Billon Ingot", "",
      LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), "", "&3Supreme Component");

  public static final SlimefunItemStack CARD_BRONZE_INGOT = new SlimefunItemStack("SUPREME_CARD_BRONZE",
      Material.MUSIC_DISC_BLOCKS, "&bCard Machine Bronze Ingot", "", "&fChange to Production Bronze Ingot", "",
      LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), "", "&3Supreme Component");

  public static final SlimefunItemStack CARD_BRASS_INGOT = new SlimefunItemStack("SUPREME_CARD_BRASS",
      Material.MUSIC_DISC_BLOCKS, "&bCard Machine Brass Ingot", "", "&fChange to Production Brass Ingot", "",
      LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), "", "&3Supreme Component");

  public static final SlimefunItemStack CARD_SULFATE = new SlimefunItemStack("SUPREME_CARD_SULFATE",
      Material.MUSIC_DISC_BLOCKS, "&bCard de Sulfate", "", "&fChange to Production Sulfate", "",
      LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), "", "&3Supreme Component");

  public static final SlimefunItemStack CARD_CARBON = new SlimefunItemStack("SUPREME_CARD_CARBON",
      Material.MUSIC_DISC_BLOCKS, "&bCard Machine Carbon", "", "&fChange to Production Carbon", "",
      LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_SILICON = new SlimefunItemStack("SUPREME_CARD_SILICON",
  ...
  public static final SlimefunItemStack CARD_NICKEL = new SlimefunItemStack("SUPREME_CARD_NICKEL",
      Material.MUSIC_DISC_BLOCKS, "&bCard Machine Nickel", "", "&fChange to Production Nickel", "",
      LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_FERROSILICON = new SlimefunItemStack("SUPREME_CARD_FERROSILICON",
      Material.MUSIC_DISC_BLOCKS, "&bCard Machine Ferrosilicon", "", "&fChange to Production Ferrosilicon", "",
      LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_DAMASCUS = new SlimefunItemStack("SUPREME_CARD_DAMASCUS",
      Material.MUSIC_DISC_BLOCKS, "&bCard Machine Damascus", "", "&fChange to Production Damascus", "",
      LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_COBALT = new SlimefunItemStack("SUPREME_CARD_COBALT",
      Material.MUSIC_DISC_BLOCKS, "&bCard Machine Cobalt", "", "&fChange to Production Cobalt", "",
      LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_DURALUMIN_INGOT = new SlimefunItemStack("SUPREME_CARD_DURALUMIN",
  ...
  public static final SlimefunItemStack CARD_ALUMINUM_BRASS_INGOT = new SlimefunItemStack("SUPREME_CARD_ALUMINUM_BRASS",
  ...
  public static final SlimefunItemStack CARD_GOLD24K = new SlimefunItemStack("SUPREME_CARD_GOLD24K",
      Material.MUSIC_DISC_CHIRP, "&bCard Machine Gold 24k", "", "&fChange to Production Ouro 24k", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_CARBON_PRESS = new SlimefunItemStack("SUPREME_CARD_CARBON_PRESS",
      Material.MUSIC_DISC_CHIRP, "&bCard Machine Compressed Carbon", "", "&fChange to Production Compressed Carbon", "",
      LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_HARDENED_METAL_INGOT = new SlimefunItemStack("SUPREME_CARD_HARDENED_METAL",
  ...
  public static final SlimefunItemStack CARD_REDSTONE_ALLOY = new SlimefunItemStack("SUPREME_CARD_REDSTONE_ALLOY",
      Material.MUSIC_DISC_CHIRP, "&bCard Machine Redstone Alloy", "", "&fChange to Production Redstone Alloy", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_PLASTIC_SHEET = new SlimefunItemStack("SUPREME_CARD_PLASTIC_SHEET",
      Material.MUSIC_DISC_CHIRP, "&bCard Machine Plastic Sheet", "", "&fChange to Production Plastic Sheet", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_BATTERY = new SlimefunItemStack("SUPREME_CARD_BATTERY",
      Material.MUSIC_DISC_CHIRP, "&bCard Machine Battery", "", "&fChange to Production Battery", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_MAGNET = new SlimefunItemStack("SUPREME_CARD_MAGNET",
      Material.MUSIC_DISC_CHIRP, "&bCard Machine Magnet", "", "&fChange to Production Magnet", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_ELECTRO_MAGNET = new SlimefunItemStack("SUPREME_CARD_ELECTRO_MAGNET",
      Material.MUSIC_DISC_MALL, "&bCard Machine Electro Magnet", "", "&fChange to Production Electro Magnet", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_ELECTRIC_MOTOR = new SlimefunItemStack("SUPREME_CARD_ELECTRIC_MOTOR",
      Material.MUSIC_DISC_MALL, "&bCard Machine Electric Motor", "", "&fChange to Production Electric Motor", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_HEATING_COIL = new SlimefunItemStack("SUPREME_CARD_HEATING_COIL",
  ...
  public static final SlimefunItemStack CARD_SYNTHETIC_EMERALD = new SlimefunItemStack("SUPREME_CARD_SYNTHETIC_EMERALD",
      Material.MUSIC_DISC_MALL, "&bCard Machine Synthetic Emerald", "", "&fChange to Production Synthetic Emerald", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_SYNTHETIC_DIAMOND = new SlimefunItemStack("SUPREME_CARD_SYNTHETIC_DIAMOND",
      Material.MUSIC_DISC_MALL, "&bCard Machine Synthetic Diamond", "", "&fChange to Production Synthetic Diamond", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), "", "&3Supreme Component");


  public static final SlimefunItemStack CARD_CARBONADO = new SlimefunItemStack("SUPREME_CARD_CARBONADO",
