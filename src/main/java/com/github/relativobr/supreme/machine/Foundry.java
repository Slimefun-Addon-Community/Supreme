...
public class Foundry extends MediumContainerMachine {
  ...
  public static final AbstractItemRecipe RECIPE_BLISTERING_INGOT_3 = new AbstractItemRecipe(
      new ItemStack[]{SupremeCoreAlloy.RESOURCE_CORE_EMERALD,
          SupremeCoreAlloy.RESOURCE_CORE_EMERALD, SupremeCoreAlloy.RESOURCE_CORE_EMERALD,
          SupremeCoreAlloy.RESOURCE_CORE_GOLD, SupremeCoreAlloy.RESOURCE_CORE_GOLD,
          SupremeCoreAlloy.RESOURCE_CORE_GOLD, SupremeCoreAlloy.RESOURCE_CORE_EMERALD,
  ...
  public static final AbstractItemRecipe RECIPE_REDSTONE_ALLOY = new AbstractItemRecipe(
      new ItemStack[]{SupremeCoreAlloy.RESOURCE_CORE_REDSTONE,
          SupremeCoreAlloy.RESOURCE_CORE_REDSTONE,
          SupremeCoreAlloy.RESOURCE_CORE_REDSTONE, SupremeCoreAlloy.RESOURCE_CORE_DIAMOND,
          SupremeCoreAlloy.RESOURCE_CORE_DIAMOND, SupremeCoreAlloy.RESOURCE_CORE_DIAMOND,
          SupremeCoreAlloy.RESOURCE_CORE_REDSTONE,
          SupremeCoreAlloy.RESOURCE_CORE_REDSTONE,
          SupremeCoreAlloy.RESOURCE_CORE_REDSTONE},
  ...
  public static final AbstractItemRecipe RECIPE_HARDENED_METAL_INGOT = new AbstractItemRecipe(
      new ItemStack[]{SupremeCoreAlloy.RESOURCE_CORE_LAPIS,
          SupremeCoreAlloy.RESOURCE_CORE_LAPIS, SupremeCoreAlloy.RESOURCE_CORE_LAPIS,
          SupremeCoreAlloy.RESOURCE_CORE_DIAMOND, SupremeCoreAlloy.RESOURCE_CORE_DIAMOND,
          SupremeCoreAlloy.RESOURCE_CORE_DIAMOND, SupremeCoreAlloy.RESOURCE_CORE_LAPIS,
          SupremeCoreAlloy.RESOURCE_CORE_LAPIS, SupremeCoreAlloy.RESOURCE_CORE_LAPIS},
  ...
  public static final AbstractItemRecipe RECIPE_ENCHANTED_GOLDEN_APPLE = new AbstractItemRecipe(
      new ItemStack[]{SupremeCoreAlloy.RESOURCE_CORE_GOLD,
          SupremeCoreAlloy.RESOURCE_CORE_GOLD, SupremeCoreAlloy.RESOURCE_CORE_GOLD,
          SupremeCoreLife.RESOURCE_CORE_APPLE, SupremeCoreLife.RESOURCE_CORE_APPLE,
          SupremeCoreLife.RESOURCE_CORE_APPLE, SupremeCoreAlloy.RESOURCE_CORE_GOLD,
          SupremeCoreAlloy.RESOURCE_CORE_GOLD, SupremeCoreAlloy.RESOURCE_CORE_GOLD},
  ...
  public static final AbstractItemRecipe RECIPE_SOLAR_PANEL = new AbstractItemRecipe(
      new ItemStack[]{SupremeCoreAlloy.RESOURCE_CORE_QUARTZ,
          SupremeCoreAlloy.RESOURCE_CORE_QUARTZ, SupremeCoreAlloy.RESOURCE_CORE_QUARTZ,
          SupremeCoreDeath.RESOURCE_CORE_STRING, SupremeCoreDeath.RESOURCE_CORE_STRING,
          SupremeCoreDeath.RESOURCE_CORE_STRING, SupremeCoreAlloy.RESOURCE_CORE_QUARTZ,
          SupremeCoreAlloy.RESOURCE_CORE_QUARTZ, SupremeCoreAlloy.RESOURCE_CORE_QUARTZ},
  ...
  public static final AbstractItemRecipe RECIPE_OIL_BUCKET = new AbstractItemRecipe(
      new ItemStack[]{SupremeCoreColor.RESOURCE_CORE_BLACK,
          SupremeCoreColor.RESOURCE_CORE_BLACK, SupremeCoreColor.RESOURCE_CORE_BLACK,
          SupremeCoreAlloy.RESOURCE_CORE_IRON, SupremeCoreAlloy.RESOURCE_CORE_IRON,
          SupremeCoreAlloy.RESOURCE_CORE_IRON, SupremeCoreColor.RESOURCE_CORE_BLACK,
          SupremeCoreColor.RESOURCE_CORE_BLACK, SupremeCoreColor.RESOURCE_CORE_BLACK},
  ...
  public static final AbstractItemRecipe RECIPE_PLASTIC_SHEET = new AbstractItemRecipe(
      new ItemStack[]{SupremeCoreDeath.RESOURCE_CORE_STRING,
          SupremeCoreDeath.RESOURCE_CORE_STRING, SupremeCoreDeath.RESOURCE_CORE_STRING,
          SupremeCoreBlock.RESOURCE_CORE_GRAVEL, SupremeCoreBlock.RESOURCE_CORE_GRAVEL,
          SupremeCoreBlock.RESOURCE_CORE_GRAVEL, SupremeCoreDeath.RESOURCE_CORE_STRING,
          SupremeCoreDeath.RESOURCE_CORE_STRING, SupremeCoreDeath.RESOURCE_CORE_STRING},
