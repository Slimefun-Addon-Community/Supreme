...
public class SupremeQuarry {
  ...
  public static final SlimefunItemStack COBBLESTONE_QUARRY =
      new SlimefunItemStack(
          "SUPREME_COBBLESTONE_QUARRY",
          ...
          UtilEnergy.energyBuffer(10000),
          "", "&3Supreme Machine");
  public static final ItemStack[] MACHINE_COBBLESTONE_QUARRY =
      new ItemStack[] {
          SupremeComponents.ADAMANTIUM_PLATE, SupremeComponents.INDUCTIVE_MACHINE, SupremeComponents.ADAMANTIUM_PLATE,
          new ItemStack(Material.DIAMOND_PICKAXE), SlimefunItems.PROGRAMMABLE_ANDROID_MINER, new ItemStack(Material.DIAMOND_PICKAXE),
