...
public class SupremeQuarry {
  ...
  public static final SlimefunItemStack UNIQUENUGGETS_QUARRY = new SlimefunItemStack("SUPREME_UNIQUENUGGETS_QUARRY",
  ...
  public static final ItemStack[] MACHINE_SUPREMENUGGETS_QUARRY = new ItemStack[]{SupremeCetrus.CETRUS_LUMIUM,
  ...
  public static final SlimefunItemStack THORNIUM_QUARRY = new SlimefunItemStack("SUPREME_THORNIUM_QUARRY",
      "6ddd4a12da1cc2c9f9d6cd49fc778e3a11f3757de6dd312d70a0d47885189c0", "&eThornium Quarry", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), UtilEnergy.energyPowerPerItem(10),
      UtilEnergy.energyBuffer(1000), "", "&3Supreme Machine");
  public static final ItemStack[] MACHINE_THORNIUM_QUARRY = new ItemStack[]{SupremeCetrus.CETRUS_LUMIUM,
  ...
  public static final SlimefunItemStack DIAMOND_QUARRY = new SlimefunItemStack("SUPREME_DIAMOND_QUARRY",
      "666070ce03a545ee4d263bcf27f36338d249d7cb7a2376f92c1673ae134e04b6", "&eDiamond Quarry", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), UtilEnergy.energyPowerPerItem(10),
      UtilEnergy.energyBuffer(1000), "", "&3Supreme Machine");
  public static final ItemStack[] MACHINE_DIAMOND_QUARRY = new ItemStack[]{SupremeCetrus.CETRUS_AQUA,
  ...
  public static final SlimefunItemStack GOLD_QUARRY = new SlimefunItemStack("SUPREME_GOLD_QUARRY",
  ...
  public static final ItemStack[] MACHINE_GOLD_QUARRY = new ItemStack[]{SupremeCetrus.CETRUS_LUX,
  ...
  public static final SlimefunItemStack IRON_QUARRY = new SlimefunItemStack("SUPREME_IRON_QUARRY",
      "f8eecae423359d3f5efd1063a9a7bcfaa43839d75d3b223c808df7961dd173d0", "&eIron Quarry", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), UtilEnergy.energyPowerPerItem(20),
      UtilEnergy.energyBuffer(10000), "", "&3Supreme Machine");
  public static final ItemStack[] MACHINE_IRON_QUARRY = new ItemStack[]{SupremeCetrus.CETRUS_VENTUS,
  ...
  public static final SlimefunItemStack COAL_QUARRY = new SlimefunItemStack("SUPREME_COAL_QUARRY",
      "579ee734b739c0d19546d5b4b049c01a055506cc00b0cfcbf177883d2c814c04", "&eCoal Quarry", "",
      LoreBuilder.machine(MachineTier.ADVANCED, MachineType.MACHINE), UtilEnergy.energyPowerPerItem(20),
      UtilEnergy.energyBuffer(10000), "", "&3Supreme Machine");
  public static final ItemStack[] MACHINE_COAL_QUARRY = new ItemStack[]{SupremeCetrus.CETRUS_IGNIS,
      SupremeComponents.ALLOY_PLATINUM, SupremeCetrus.CETRUS_IGNIS, new ItemStack(Material.DIAMOND_PICKAXE),
      SlimefunItems.GEO_MINER, new ItemStack(Material.DIAMOND_PICKAXE), SlimefunItems.COAL_GENERATOR,
      SlimefunItems.CARBON_PRESS, SlimefunItems.LARGE_CAPACITOR};

  public static final SlimefunItemStack COBBLESTONE_QUARRY = new SlimefunItemStack("SUPREME_COBBLESTONE_QUARRY",
      "139ac257f4e04adc6ab3e46fd3b28749e866faa9ce6a1d6d526e0e3864d9222", "&eCobblestone Quarry", "",
      LoreBuilder.machine(MachineTier.MEDIUM, MachineType.MACHINE), UtilEnergy.energyPowerPerItem(20),
      UtilEnergy.energyBuffer(10000), "", "&3Supreme Machine");
  public static final ItemStack[] MACHINE_COBBLESTONE_QUARRY = new ItemStack[]{SupremeComponents.ADAMANTIUM_PLATE,
