...
public class SupremeQuarry {
  ...
  public static final SlimefunItemStack STONE_QUARRY = new SlimefunItemStack("SUPREME_STONE_QUARRY",
  ...
  public static final SlimefunItemStack SUPREME_NUGGETS_QUARRY = new SlimefunItemStack("SUPREME_SUPREME_NUGGETS_QUARRY",
