...
public class MagicAltar extends MediumContainerMachine {
  ...
  public static final AbstractItemRecipe RECIPE_RUNE_AIR = new AbstractItemRecipe(new SlimefunItemStack(SlimefunItems.AIR_RUNE, 4),
  ...
  public static final AbstractItemRecipe RECIPE_ELYTRA_SCALE = new AbstractItemRecipe(
      ...
      new ItemStack[]{new ItemStack(SlimefunItems.ENDER_LUMP_3), new ItemStack(SlimefunItems.AIR_RUNE),
          ...
          new ItemStack(SlimefunItems.ENDER_LUMP_3)});
  public static final AbstractItemRecipe RECIPE_ELITROS = new AbstractItemRecipe(new ItemStack(Material.ELYTRA, 1),
