...
public class MagicAltar extends MediumContainerMachine {
  ...
  public static final ItemStack[] RECIPE_MAGIC_ALTAR_MACHINE_III = new ItemStack[]{SupremeComponents.THORNERITE,
      SupremeCetrus.CETRUS_LUMIUM, SupremeComponents.THORNERITE, SupremeComponents.SUPREME,
  ...
  public static final SimpleRecipe RECIPE_RUNE_AIR = new SimpleRecipe(new SlimefunItemStack(SlimefunItems.AIR_RUNE, 4),
  ...
  public static final SimpleRecipe RECIPE_MAGICAL_BOOK_COVER = new SimpleRecipe(
      ...
      new ItemStack[]{null, new ItemStack(SlimefunItems.MAGIC_LUMP_2), null, new ItemStack(SlimefunItems.MAGIC_LUMP_2),
          ...
          new ItemStack(SlimefunItems.MAGIC_LUMP_2), null});
  ...
  public static final SimpleRecipe RECIPE_ELYTRA_SCALE = new SimpleRecipe(
      ...
      new ItemStack[]{new ItemStack(SlimefunItems.ENDER_LUMP_3), new ItemStack(SlimefunItems.AIR_RUNE),
          ...
          new ItemStack(SlimefunItems.ENDER_LUMP_3)});
  public static final SimpleRecipe RECIPE_ELITROS = new SimpleRecipe(new ItemStack(Material.ELYTRA, 1),
