...
public class ElectricCrafter extends MediumContainerMachine {
  ...
  public static final SimpleRecipe RECIPE_SYNTHETIC_AMETHYST = new SimpleRecipe(
      SupremeComponents.SYNTHETIC_AMETHYST,
      SupremeComponents.RECIPE_SYNTHETIC_AMETHYST);
  public static final SimpleRecipe RECIPE_SYNTHETIC_RUBY = new SimpleRecipe(
