...
public class WeaponsThornium {
  ...
  public static final SlimefunItemStack THORNIUM_BOW_SUPREME = new SupremeItemStack("SUPREME_BOW_SUPREME", Material.BOW,
      "&4&lSupreme Bow", "&f&lA Supreme Bow ofThornium", "", "&3Supreme Weapons");
