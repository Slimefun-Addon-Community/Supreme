...
public final class WeaponsBasic {
  ...
  public static final SlimefunItemStack ADAMANTIUM_SWORD = new SlimefunItemStack("SUPREME_ADAMANTIUM_SWORD",
      Material.DIAMOND_SWORD, "&f&lAdamantium Sword", "&f&lA Sword of Adamantium", "", "&3Supreme Weapons");
  ...
  public static final SlimefunItemStack AURUM_SWORD = new SlimefunItemStack("SUPREME_AURUM_SWORD",
      Material.DIAMOND_SWORD, "&f&lAurum Sword", "&f&lA Sword of Aurum", "", "&3Supreme Weapons");
  ...
  public static final SlimefunItemStack TITANIUM_SWORD = new SlimefunItemStack("SUPREME_TITANIUM_SWORD",
      Material.DIAMOND_SWORD, "&f&lTitanium Sword", "&f&lA Sword of Titanium", "", "&3Supreme Weapons");
