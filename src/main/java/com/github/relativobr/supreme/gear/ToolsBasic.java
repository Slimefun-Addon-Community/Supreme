...
public final class ToolsBasic {
  ...
  public static final SlimefunItemStack ADAMANTIUM_AXE = new SlimefunItemStack("SUPREME_ADAMANTIUM_AXE",
      Material.DIAMOND_AXE, "&f&lAdamantium Axe", "&f&lA Axe of Adamantium", "", "&3Supreme Tools");
  ...
  public static final SlimefunItemStack AURUM_AXE = new SlimefunItemStack("SUPREME_AURUM_AXE", Material.DIAMOND_AXE,
      "&f&lAurum Axe", "&f&lA Axe of Aurum", "", "&3Supreme Tools");
  ...
  public static final SlimefunItemStack TITANIUM_AXE = new SlimefunItemStack("SUPREME_TITANIUM_AXE",
      Material.DIAMOND_AXE, "&f&lTitanium Axe", "&f&lA Axe of Titanium", "", "&3Supreme Tools");
  ...
  public static final SlimefunItemStack ADAMANTIUM_PICKAXE = new SlimefunItemStack("SUPREME_ADAMANTIUM_PICKAXE",
      Material.DIAMOND_PICKAXE, "&f&lAdamantium Pickaxe", "&f&lA Pickaxe of Adamantium", "", "&3Supreme Tools");
  ...
  public static final SlimefunItemStack AURUM_PICKAXE = new SlimefunItemStack("SUPREME_AURUM_PICKAXE",
      Material.DIAMOND_PICKAXE, "&f&lAurum Pickaxe", "&f&lA Pickaxe of Aurum", "", "&3Supreme Tools");
  ...
  public static final SlimefunItemStack TITANIUM_PICKAXE = new SlimefunItemStack("SUPREME_TITANIUM_PICKAXE",
      Material.DIAMOND_PICKAXE, "&f&lTitanium Pickaxe", "&f&lA Pickaxe of Titanium", "", "&3Supreme Tools");
  ...
  public static final SlimefunItemStack ADAMANTIUM_SHOVEL = new SlimefunItemStack("SUPREME_ADAMANTIUM_SHOVEL",
      Material.DIAMOND_SHOVEL, "&f&lAdamantium Shovel", "&f&lA Shovel of Adamantium", "", "&3Supreme Tools");
  ...
  public static final SlimefunItemStack AURUM_SHOVEL = new SlimefunItemStack("SUPREME_AURUM_SHOVEL",
      Material.DIAMOND_SHOVEL, "&f&lAurum Shovel", "&f&lA Shovel of Aurum", "", "&3Supreme Tools");
  public static final ItemStack[] RECIPE_AURUM_SHOVEL = {null, SupremeComponents.AURUM_PLATE, null, null,
      new ItemStack(Material.STICK), null, null, new ItemStack(Material.STICK), null};

  public static final SlimefunItemStack TITANIUM_SHOVEL = new SlimefunItemStack("SUPREME_TITANIUM_SHOVEL",
      Material.DIAMOND_SHOVEL, "&f&lTitanium Shovel", "&f&lA Shovel of Titanium", "", "&3Supreme Tools");
