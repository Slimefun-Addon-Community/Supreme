    ...
    if (supremeOptions == null) {
      ...
      if (typeSection == null) {
        ...
        supremeOptions = SupremeOptions.builder()
                ...
                .chunkLimitMaxTechGenerator(typeSection.getInt("chunk-limit-max-tech-generator", 100))
                .chunkLimitMaxTechMutation(typeSection.getInt("chunk-limit-max-tech-mutation", 100))
                .chunkLimitMaxTechRobotic(typeSection.getInt("chunk-limit-max-tech-robotic", 100))
                .chunkLimitMaxMobTechCollector(typeSection.getInt("chunk-limit-max-mob-tech-collector", 100))
